...
async function main() {
  ...
  await prisma.message.createMany({
    data: [
      ...
      },
      {
        ...
        receiverId: manager.id,
        tenantId: tenants[0].tenant.id,
        subject: "Follow-up on hallway light",
        body: "Hallway light outside 2B still out. Office said they’d look — checking status.",
        type: PortalMessageType.MAINTENANCE,
  ...
  console.log("  player5@havenpm.com / dad@havenpm.com → Dad");
  console.log("\nVendors:");
