...
const SHARED_OPENERS = [
  ...
  "Quill’s hat brim cuts the sun into a usable blade; the scarred eye does the rest.",
...
const SHARED_MIDDLES = [
  ...
  "Ash keeps counsel; Quill keeps a ledger of silences and a flask of worse truths.",
  ...
  "Quill says, “Pretty country. Ugly ownership. Pass the damn bottle.”",
  ...
  "Quill files every kindness under “possibly tactical” and drinks to the filing.",
  ...
  "Quill’s tea tastes like boiled warrants, patience, and whiskey that lost an argument.",
  ...
  "Quill mutters law under his breath like a protective curse, then swears for emphasis.",
...
const SHARED_CLOSERS = [
  ...
  "Ash sets the pace like a man owed a name and too stubborn to renegotiate.",
  "Quill tips his ruined hat at unfinished justice and takes a pull.",
...
const CHAPTER_FLAVOR = {
  1: {
    openers: [
      ...
      "Quill buys your freedom like a man purchasing a complicated knife — and a headache.",
    ...
    middles: [
      ...
      "Quill’s crossbow speaks better law than half the magistrates east — and swears better too.",
      "Road vermin sell water and buy stories about numbered men who would not quit.",
      "The first warrant tastes like ash roofs and unfinished graves.",
    ],
    closers: [
      "Collar mud still clings; freemark ink is drying on purpose.",
      "Quill files Lowhedge under “paid in blood or nearly” and takes a pull.",
      ...
      "You walk west, then south, then wherever vengeance keeps maps — stubborn as weather.",
  ...
  2: {
    openers: [
      ...
      "Quill turns paddocks into a school where failure pays tuition in bruises and flask-lectures.",
    ...
    middles: [
      "Quill says, “Hills first. Rivers remember who you were. I remember who won’t quit.”",
      ...
      "Quill reads ledgers like scripture written by committed bastards, whiskey for punctuation.",
...
export const ROAD_CHOICES = {
  1: [
    ...
    },
    {
      ...
      body: "At dusk Quill asks whether you want to be a freeman who hunts, or a hunter who happens to be free — then drinks like the answer might offend him. The difference, he says, is who you apologize to when the smoke clears. “And don’t you damn quit either way.”",
      art: "quill-aside",
      choices: [
        {
          id: "ch1-joke-free",
          ...
          outcome: {
            text: "“Then we hunt like guests,” Quill says. “Violent guests. Stubborn ones.”",
            xp: 10,
        ...
        },
        {
          ...
          outcome: {
            text: "Quill almost smiles with the scarred eye. “Honest. Ugly. Useful.”",
            xp: 10,
        ...
        },
        {
          ...
          outcome: {
            text: "“Categories are cages,” Quill allows. “Fine. Be a vow with a sword that won’t quit.”",
            xp: 12,
  ...
  1: [
    {
      ...
      body: "“I buy thralls who can ruin the men who sold them,” Quill says, not unkind, flask catching firelight. “If that offends your poetry, walk. If it fits your teeth, load — and if you quit mid-road, I’ll leave you for the crows with a receipt.” Ash loads.",
      art: "quill-hat",
    },
    {
      title: "Vern's Joke",
