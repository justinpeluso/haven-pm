...
const THEME_TO_FOE: Record<string, string> = {
  ...
  "glade-raiders": "neon-glade-jackal",
  "road-wargs": "dust-trail-warg",
  "cage-tenders": "coffle-guard",
  "neon-scavs": "fiber-oak-drifter",
  "brand-hounds": "night-howler",
  "spirit-hounds": "humming-sap-thief",
  "biolume-thieves": "humming-sap-thief",
  "barcode-mites": "barcode-mite",
  "warrant-runners": "sku-brand-runner",
  "hill-goblins": "hill-signal-goblin",
  "dust-wargs": "stim-cartel-hound",
  "bounty-thieves": "bounty-glyph-thief",
  "debt-drones": "debt-collector-drone",
  "mark-hunters": "ash-cloak-outrider",
  "spy-ravens": "trace-crow",
  "orc-outriders": "orc-rider",
  "paid-knights": "iron-cuff-overseer",
  "pixel-sprites": "pale-pixel-sprite",
  "river-slavers": "barge-hook-orc",
  "barge-trolls": "bridge-brute",
  "muck-spiders": "chromeveil-barnacle",
  "toll-orcs": "toll-booth-specter",
  "coolant-eels": "coolant-river-eel",
  "silk-drakes": "muckfen-silk-drake",
  "gate-guards": "helix-smile-sentry",
  "mire-orcs": "mire-orc-shaman",
  "war-mastiffs": "gate-mastiff-chrome",
  "wicker-sentries": "wicker-code-sentry",
  "vale-clerks": "director-vale-clerk",
  "overseer-orcs": "collar-yard-overseer",
  "house-blades": "house-blade-duelist",
  "punishment-hounds": "seal-yard-hound",
  "collared-champions": "ring-forge-golem",
  "bed-ghosts": "numbered-bed-ghost",
  "seal-cult": "seal-breaker-cultist",
  "pit-champions": "undervault-gladiator",
  "arena-trolls": "arena-silk-brute",
  "spectating-knights": "cade-betting-knight",
  "cade-favorites": "neon-pit-drake",
  "mandolin-fiends": "pit-mandolin-fiend",
  "cade-host": "spirefall-militia-orc",
  "elite-orcs": "gridfire-berserker",
  "burning-tower-guards": "tower-guard-elite",
  "warg-cavalry": "warg-cavalry-outrider",
  "grid-wargs": "burning-grid-warg",
  "spire-aces": "spire-drone-ace",
  "remnant-hunters": "ash-horizon-walker",
  "storm-wargs": "storm-warg-alpha",
  "last-enforcers": "last-enforcer-prime",
  "memory-shades": "memory-shade-twin",
  "pale-echoes": "pale-project-echo",
  "westwind-drakes": "westwind-dragonling",
};
